...
class AnimateSprite(pygame.sprite.Sprite):
    ...
    #definir les choses à faire à la creation de l'entité
    ...
    def animate(self, loop=False):
        ...
        if self.animation:
            ...
            #verifier si on atteint la fin de l'animatoin
...
def load_animation_images(sprite_name):
    #charger les 24 images de ce sprite dans le dossier correspond
    images = []
...
#definir un dictionnaire qui va contenir les images chargées de chaque element pour identifier les differents acteurs
animations = {
